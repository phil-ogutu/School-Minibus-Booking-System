...
const initialBuses = [
  ...
  { id: 3, numberPlate: "KDC 789C", capacity: 50, driver: "James Mwangi" },
];
...
export default function ManageBuses() {
  ...
  const handleAddTrip = async () => {
    if (!newTrip.bus_id || !newTrip.trip_date) {
      alert("Please select a bus and date");
      return;
    }
    await createTrip(newTrip);
    setNewTrip({ bus_id: "", trip_date: "" });
  };
          ...
          {(trips.length
            ...
            : [
                ...
                },
                {
                  id: 2,
                  bus: { plate: "KDB 456B" },
                  trip_date: "2025-07-26",
                },
                {
                  id: 3,
                  bus: { plate: "KDC 789C" },
                  trip_date: "2025-07-27",
                },
              ]
          ).map((trip) => (
